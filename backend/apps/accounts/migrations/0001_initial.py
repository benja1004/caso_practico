    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('rol', models.CharField(choices=[('ADMIN', 'Administrador'), ('MEDICO', 'Medico'), ('PACIENTE', 'Paciente')], default='PACIENTE', max_length=10)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('centro_salud', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, related_name='medicos', to='accounts.centrosalud')),
                ('especialidad', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, related_name='medicos', to='accounts.especialidad')),
